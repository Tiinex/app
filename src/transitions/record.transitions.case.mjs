...
import { rootValidate } from '@tiinex/core/schemas/tiinex.root.v1.validate.js';
import { resolveLineage } from '@tiinex/core/lineage/lineage.resolve.js';
import { createContinuationDraft, createReferenceDraft, ensureUniqueTransitionPath, listContinuationTargets, RECORD_TRANSITION_RESULT_SCHEMA_ID } from '@tiinex/core/transitions/record.transitions.js';
