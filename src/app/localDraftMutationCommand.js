...
import { canDiscardLocalDraft, canEditLocalDraft, artifactSchemaId } from '@tiinex/core/artifacts/artifact.localDraft.js';
import { resolveSchemaModule } from '@tiinex/core/schemas/resolver.js';
import { durableLocalMutationDecision, DurableLocalMutationOperation } from './durableLocalMutationPolicy.js';
import { validateLegacyTaskDraftCompatibility } from '@tiinex/core/schemas/core/task/tiinex.task.v1.validate.js';
import { canonicalC14nV2SelfState, sealC14nV2Self } from '@tiinex/core/integrity/integrity.c14nV2.js';
