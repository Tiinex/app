...
import { acceptPortablePublicationResult, planPortablePublication } from '@tiinex/core/tooling/portable/publication/runtime.publication.js';
import {
  GITHUB_ISSUE_BODY_TARGET_KIND,
  GITHUB_ISSUE_COMMENT_TARGET_KIND,
  GITHUB_REPO_FILE_TARGET_KIND
} from '@tiinex/core/publication/publication.targetContract.js';
import { parseExactGithubIssueTarget } from '@tiinex/core/sources/github/github.issueTarget.js';
