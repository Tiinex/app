...
import { projectCommonCliDefaultOutput } from '@tiinex/core/tooling/portable/adapters/cli/cli.common-output.js';
import { groundContinuationOperationInput } from '@tiinex/core/tooling/portable/adapters/cli/cli.ground-materialize.js';
