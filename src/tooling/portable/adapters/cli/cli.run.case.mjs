...
import { acceptGroundHostResult, hostToolProfile } from '@tiinex/core/tooling/portable/adapters/cli/cli.ground-recovery.js';
import { runPortableOperation } from '@tiinex/core/tooling/portable/operation.catalog.js';
import { materializeHandoffManufactureCliOutput, prepareHandoffManufactureCliCommand } from '@tiinex/core/tooling/portable/adapters/cli/cli.handoff-manufacture.js';
