...
import { finalizeFile } from '@tiinex/core/export/package.fileMap.js';
import { prepareHandoffManufactureCliCommand } from '@tiinex/core/tooling/portable/adapters/cli/cli.handoff-manufacture.js';
import { advanceHandoffCarrierMajor, continueHandoffCarrierLineage, initialHandoffCarrierLineage, parentHandoffCarrierLineageFromBundle, qualifyMajorCarrierReadiness } from '@tiinex/core/tooling/portable/handoff/carrierLineage.js';
import { renderHandoffPackageV1 } from '@tiinex/core/tooling/portable/handoff/recipientV2.packageV1.contract.js';
import { buildRecipientV2TransportManifestFile, recipientV2TransportFacts } from '@tiinex/core/tooling/portable/handoff/recipientV2.transportManifest.js';
